...
set JARPATH=%APP_HOME%\lib\aviation-weather-producer-1.0.0.jar

@rem Execute aviation-weather-producer
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %AVIATION_WEATHER_PRODUCER_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%AVIATION_WEATHER_PRODUCER_EXIT_CONSOLE%" exit 1
exit /b 1
